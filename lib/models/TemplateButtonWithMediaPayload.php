...
/**
 * TemplateButtonWithMediaPayload Class Doc Comment
 *
 * @category Class
 * @package  WhatsAPI
 * @author   OpenAPI Generator team
 ...
 */
class TemplateButtonWithMediaPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateButtonWithMediaPayload';
    ...
    protected static $openAPITypes = [
        'buttons' => '\WhatsAPI\models\TemplateButton[]',
        'content_text' => 'string',
        'footer' => 'string',
        'media' => '\WhatsAPI\models\FileUpload',
        'to' => 'string'
    ];
    ...
    */
     ...
     * Gets buttons
     *
     * @return \WhatsAPI\models\TemplateButton[]
     */
     ...
     * Sets buttons
     *
     * @param \WhatsAPI\models\TemplateButton[] $buttons buttons
     *
     * @return self
     */
     ...
     * Gets media
     *
     * @return \WhatsAPI\models\FileUpload
     */
     ...
     * Sets media
     *
     * @param \WhatsAPI\models\FileUpload $media media
     *
     * @return self
     */
