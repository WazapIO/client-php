...
*InstanceApi* | [**createInstance**](docs/Api/InstanceApi.md#createinstance) | **POST** /instances/create | Creates a new instance key.
...
- [CreateInstancePayload](docs/Model/CreateInstancePayload.md)
